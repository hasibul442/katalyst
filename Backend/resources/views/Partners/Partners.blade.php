...
<section>
    <div class="card">
        <div class="card-body">
            ...
            <div class="text-center"><button type="button" class="btn btn-outline-primary" data-bs-toggle="modal" data-bs-target="#PartnersAdd">Partners Add</button></div>
                ...
                <table class="table display" width="100%" id="example">
                    ...
                    <tbody>
                        ...
                        <tr id="auxiliary-{{ $item->id }}">
                            ...
                            <td><img src="{{ asset('/assets/image/Partners/'.$item->logo) }}" alt="" style="width: 100px; height:100px"></td>
...
<!--Add Modal -->
<div class="modal fade" id="PartnersAdd" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered modal-lg">
        <div class="modal-content">
            <div class="modal-body">
                <form class="forms-sample" id="PartnersForm" method="POST" enctype="multipart/form-data">
                    @csrf
...
<script>
    $('#PartnersForm').on('submit', function(e) {
        ...
        var myformData = new FormData($('#PartnersForm')[0]);
        $.ajax({
            type: "post"
            , url: "/partners/add"
            , data: myformData
            ...
            , success: function(response) {
                ...
                $("#PartnersForm").find('input').val('');
                $('#PartnersAdd').modal('hide');
                location.reload();
            }
