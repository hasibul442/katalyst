      ...
      <section>
          ...
          <div className="container ">
            <div className="row pt-4">
              <div className="col-lg-8">
                ...
                <span><i className="fas fa-envelope" style={{color: "#65C18C"}}></i><a className="touch-with-us-text" href="mailto:info@katalystbd.com">&nbsp;info@katalystbd.com</a></span>
              </div>
        ...
        <div className="footer2">
          <p className="text-center footer-text my-auto pb-2">
            Copyright © {new Date().getFullYear()} Katalyst Bangladesh  | <small>Developed by Hasib</small>
          </p>
        </div>
      </section>
    </>
